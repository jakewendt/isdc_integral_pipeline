...
sub ISA {
	...
	#	OSA 7 - ibis_science_analysis 10.6 defaults
	my %parameters = (
		...
		"par_sum_spectra" => "no",
		"par_tolerance" => "0.1",
		"par_CAT_refCat" => "$ENV{ISDC_REF_CAT}"."[ISGRI_FLAG==1]",
		"par_chatter" => "2",
		...
		"par_GENERAL_levelList" => "COR,GTI,DEAD,BIN_I,BKG_I,CAT_I,IMA,IMA2,BIN_S,SPE,LCR,COMP,CLEAN",
		"par_CAT_usrCat" => "",
		...
		"par_IBIS_II_ChanNum" => "4",
		"par_IBIS_II_E_band_min" => "20 40 60 100",
		"par_IBIS_II_E_band_max" => "40 60 100 200",
		...
		"par_IBIS_IPS_ChanNum" => "-1",
		"par_IBIS_IPS_E_band_min_s" => "",
		"par_IBIS_IPS_E_band_max_s" => "",
		"par_IBIS_IPS_E_band_min_m" => "",
		"par_IBIS_IPS_E_band_max_m" => "",
		"par_IBIS_min_rise" => "16",
		"par_IBIS_max_rise" => "116",
		"par_IBIS_NoisyDetMethod" => "1",
		"par_IBIS_P_convFact" => "7.1",
		"par_IBIS_SI_ChanNum" => "-1",
		"par_IBIS_SI_E_band_min" => "",
		"par_IBIS_SI_E_band_max" => "",
		"par_IBIS_II_inEnergyValues" => "",
		...
		"par_SCW1_GTI_attTolerance_X" => "0.5",
		"par_SCW1_GTI_attTolerance_Z" => "3.0",
		"par_SCW1_GTI_gtiUserP" => "",
		"par_SCW1_GTI_gtiUserI" => "",
		"par_SCW1_GTI_TimeFormat" => "IJD",
		"par_SCW1_GTI_Accuracy" => "any",
		"par_SCW1_GTI_SCP" => "",
		"par_SCW1_GTI_SCI" => "",
		"par_SCW1_GTI_PICsIT" => "VETO ATTITUDE P_SGLE_DATA_GAPS P_MULE_DATA_GAPS",
		"par_SCW1_GTI_ISGRI" => "VETO ATTITUDE ISGRI_DATA_GAPS",
		"par_SCW1_GTI_BTI_Dol" => "",
		"par_SCW1_GTI_BTI_Names" => "IBIS_CONFIGURATION IBIS_BOOT ISGRI_RISE_TIME VETO_PROBLEM SOLAR_FLARE BELT_CROSSING",
		"par_SCW1_ICOR_idxSwitch" => "",
		"par_SCW1_ICOR_GODOL" => "",
		"par_SCW1_ICOR_supGDOL" => "",
		"par_SCW1_ICOR_supODOL" => "",
		"par_SCW1_ICOR_riseDOL" => "",
		"par_SCW1_ICOR_probShot" => "0.0001",
		"par_SCW1_PCOR_enerDOL" => "",
		"par_SCW1_veto_mod" => "",
		"par_SCW1_BIN_cleanTrk" => "1",
		...
		"par_rebin_arfDol" => "",
		"par_OBS1_DataMode" => "0",
		"par_OBS1_SearchMode" => "2",
		"par_OBS1_ToSearch" => "15",
		...
		"par_OBS1_MinCatSouSnr" => "6.",
		"par_OBS1_MinNewSouSnr" => "7.",
		...
		"par_ILCR_num_e" => "4",
		"par_ILCR_e_min" => "20 40 60 100",
		"par_ILCR_e_max" => "40 60 100 200",
		"par_OBS2_detThr" => "3.0",
		"par_OBS2_imgSel" => "EVT_TYPE==SINGLE && E_MIN==252 && E_MAX==336",
		"par_OBS2_projSel" => "STG",
		"par_protonDOL" => "",
	);

	$parameters{'par_IC_Group'}   = $att{IC_Group};
	$parameters{'par_CAT_refCat'} = $ENV{ISDC_REF_CAT};
	$parameters{'par_IC_Alias'}   = $ENV{IC_ALIAS};

	#	10.5 parameters that are removed in 10.6
	$parameters{'par_SCW1_ICOR_rtcDOL'} = "";
	$parameters{'par_SCW1_RTdriftCor'} = "1";
	$parameters{'par_switDOL'} = "";
	...
	if      ( $ENV{PATH_FILE_NAME} =~ /consssa/ ) {
		$parameters{'par_IBIS_II_inEnergyValues'} = "energy_bands.fits[1]";
		...
		$parameters{'par_IBIS_II_E_band_min'} = "20 40";
		$parameters{'par_IBIS_II_E_band_max'} = "40 80";
		$parameters{'par_IBIS_IPS_ChanNum'} = 0;
		$parameters{'par_SCW1_GTI_TimeFormat'} = "OBT";
		$parameters{'par_SCW1_GTI_BTI_Names'} = "";
		$parameters{'par_OBS1_SearchMode'} = 3;
		$parameters{'par_OBS1_ToSearch'} = 25;
		$parameters{'par_OBS1_MinCatSouSnr'} = 1;
		$parameters{'par_OBS1_MinNewSouSnr'} = 5;
		$parameters{'par_OBS1_SouFit'} = 1;
		$parameters{'par_ILCR_num_e'} = 2;
		$parameters{'par_ILCR_e_min'} = "15 40";
		$parameters{'par_ILCR_e_max'} = "40 300";
		$parameters{'par_OBS2_projSel'} = "TAN";
	} else {
...
#	elsif ( $ENV{PROCESS_NAME} =~ /csaob2/ ) { #		Not yet.  #	}
	...
	if ( ( $ENV{PROCESS_NAME} =~ /cssscw/ ) && ( $ENV{REDO_CORRECTION} ) ) {
		...
		#	This is the parameter to use the Alberto LUT, but we have never actually done this
	...
	if ( ( $ENV{PROCESS_NAME} =~ /cssscw/ ) && ( $ENV{MULTISTAGE} ) ) {
		...
		$parameters{'par_SCW1_GTI_attTolerance_Z'} = "0.05";
		$parameters{'par_OBS1_ExtenType'}          = "1";
