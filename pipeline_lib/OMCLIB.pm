...
sub OSA {
	...
	my ($retval,@result) = &ISDCPipeline::PipelineStep (
		...
		"par_IMA_inpCat"         => "",			#	060627 - Jake - added for SCREW 1833
		"par_IMA_maxWcsOff"      => "10.0",		#	060627 - Jake - added for SCREW 1833
		"par_IMA_wcsFlag"        => "n",			#	060627 - Jake - added for SCREW 1833
#		"par_GTI_BTI_Dol"        => "",			#	060627 - Jake - removed for SCREW 1831
#		"par_GTI_BTI_Names"      => "",			#	060627 - Jake - removed for SCREW 1831
		...
		#  SCREW 997 implemented, so will exit with 491099 if no data
		"stoponerror"            => 0,
		);
